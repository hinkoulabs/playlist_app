...
class FetchRequestsControllerTest < ActionDispatch::IntegrationTest
  context 'create' do
    should "should generate with success status" do
    ...
    should "should generate with failure status" do
    ...
    should "should generate.turbo_stream with success status" do
      stub_call_fetch_service(true)
    ...
    should "should generate.turbo_stream with failure status" do
